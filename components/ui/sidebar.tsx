...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(
  ({ className, size, collapsed, toggleable = true, collapsible = true, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        {toggleable && collapsible && (
          <button
            className="absolute -right-3 top-1/2 transform -translate-y-1/2 bg-primary text-primary-foreground rounded-full p-1 shadow-md"
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn("p-4 border-b", className)} {...props} />,
)
...
const SidebarSectionTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-xs uppercase text-muted-foreground mb-2 px-2", className)} {...props} />
  ),
)
